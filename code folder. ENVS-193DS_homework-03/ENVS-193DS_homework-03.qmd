...
cleandata <- datasheet |> #storing clean df as an object "cleandata"
  ...
  mutate(mood_level = as_factor(mood_level)) # make sure mood_level is being read in as a factor
...
ggplot(data = cleandata, #using the cleandata dataframe 
  ...
  labs(x = "mood level", # labelling the x-axis 
       y = "spotify listening time (min)") # labelling the y-axis
